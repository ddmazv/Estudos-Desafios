...
const suggestedActions = [
    {
        ...
        label: 'Properties available in the neighborhood',
        action: 'What properties are available near me?',
    },
];
...
export const ChatInput = ({ question, setQuestion, onSubmit, isLoading }: ChatInputProps) => {
    ...
    <div className="relative w-full flex flex-col gap-4">
        ...
        className={cx(
            'min-h-[24px] max-h-[calc(75dvh)] overflow-y-scroll resize-none rounded-xl text-base bg-muted',
        )}
        value={question}
